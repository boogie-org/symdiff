...
namespace RootcauseDriver
{
    ...
    {
        public static int maxParallel = 2;
        public static int timeoutPerProcess = 500;
        ...
        public static List<Tuple<Tuple<string, string, string>, Tuple<string, string>>> CollectMDILBenchmarks()
        {
            ...
            {
                //Tuple.Create(@" /equalityFixes+ /trivialFilter- /parallelFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /loadFilter+ /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter1")
                //,Tuple.Create(@" /equalityFixes+ /trivialFilter- /singleFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /storeFilter+ /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter2")
                Tuple.Create(@" /equalityFixes+ /trivialFilter- /parallelFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /calleeFilter+ /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter3")
        ...
        public static List<Tuple<Tuple<string, string, string>, Tuple<string, string>>> CollectSampleBenchmarks()
        {
            ...
            var options = new List<Tuple<string, string>>()
            {
                ...
                ,Tuple.Create(@" /equalityFixes+ /trivialFilter- /singleFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /storeFilter+ /passingTestFilter- /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter2")
                ,Tuple.Create(@" /equalityFixes+ /trivialFilter- /parallelFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /calleeFilter+ /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter3")
                ,Tuple.Create(@" /equalityFixes+ /trivialFilter- /parallelFilter- /literalFilter- /arithmeticFilter- /applyLeftFilter+ /applyRightFilter+ /movFilter+ /demonizeUninterpreted+ /constrainLeftPath+ /findEarliestMapUpdateMismatch /binarySearch /verbose:1", "filter4")
            };
        ...
        public static List<Tuple<Tuple<string, string, string>, Tuple<string, string>>> CollectTCASBenchmarks()
        {
            ...
            var options = new List<Tuple<string, string>>()  {
                            // Tuple.Create(@" /equalityFixes+ /conditionalFilter- /liftConditionals /arithmeticFilter- /literalFilter- /trivialFilter- /passingTestFilter- /demonizeUninterpreted /applyLeftFilter /applyRightFilter /independantFilter- /verbose:1", "filter1")
                            ...
                            Tuple.Create(@" /equalityFixes+ /conditionalFilter- /liftConditionals /arithmeticFilter- /literalFilter- /trivialFilter- /passingTestFilter- /demonizeUninterpreted /applyLeftFilter /applyRightFilter /independantFilter- /verbose:1 /maxsatLimit:20 /stats", "filter1"),
                            Tuple.Create(@" /equalityFixes+ /conditionalFilter+ /liftConditionals /arithmeticFilter- /literalFilter- /trivialFilter- /passingTestFilter- /demonizeUninterpreted /applyLeftFilter /applyRightFilter /independantFilter- /verbose:1 /maxsatLimit:20 /stats", "filter2"),
                            Tuple.Create(@" /equalityFixes+ /conditionalFilter- /liftConditionals /arithmeticFilter- /literalFilter- /trivialFilter- /passingTestFilter- /demonizeUninterpreted /applyLeftFilter /applyRightFilter /independantFilter- /verbose:1 /maxsatLimit:20 /constrainLeftPath /stats", "filter3"),
                            Tuple.Create(@" /equalityFixes+ /conditionalFilter+ /liftConditionals /arithmeticFilter- /literalFilter- /trivialFilter- /passingTestFilter- /demonizeUninterpreted /applyLeftFilter /applyRightFilter /independantFilter- /verbose:1 /maxsatLimit:20 /constrainLeftPath /stats", "filter4"),
                          };
            //cross product
            return dirs.SelectMany(x => options, (x, y) => Tuple.Create(Tuple.Create(x, bplFile, htmlFile), y)).ToList();
        }
