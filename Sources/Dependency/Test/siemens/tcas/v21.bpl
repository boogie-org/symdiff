...
implementation {:extern} ALIM() returns (result.ALIM$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 58} true;
  ...
  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 59} true;
    return;
}
...
implementation {:extern} Inhibit_Biased_Climb() returns (result.Inhibit_Biased_Climb$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 63} true;
  ...
  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 64} true;
    return;
...
implementation {:extern} Non_Crossing_Biased_Climb() returns (result.Non_Crossing_Biased_Climb$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 68} true;
    goto label_4;

  label_4:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 69} true;
    goto label_5;

  label_5:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 70} true;
    goto label_6;

  label_6:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 72} true;
  ...
  label_7:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 73} true;
  ...
  label_8:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 79} true;
  ...
  label_26:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 81} true;
    result.Non_Crossing_Biased_Climb$1 := result;
    assume value_is(__ctobpl_const_29, result);
    goto label_1;

  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 82} true;
    return;
  ...
  label_11:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 75} true;
...
implementation {:extern} Non_Crossing_Biased_Descend() returns (result.Non_Crossing_Biased_Descend$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 86} true;
    goto label_4;

  label_4:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 87} true;
    goto label_5;

  label_5:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 88} true;
    goto label_6;

  label_6:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 90} true;
  ...
  label_10:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 91} true;
  ...
  label_11:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 97} true;
    call result.Own_Above_Threat$6 := Own_Above_Threat();
    goto label_27;
  ...
  label_26:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 99} true;
    result.Non_Crossing_Biased_Descend$1 := result;
    assume value_is(__ctobpl_const_50, result);
    goto label_1;

  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 100} true;
    return;
  ...
  label_14:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 93} true;
    call result.Own_Below_Threat$3 := Own_Below_Threat();
    goto label_17;
...
implementation {:extern} Own_Above_Threat() returns (result.Own_Above_Threat$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 109} true;
  ...
  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 110} true;
    return;
}
...
implementation {:extern} Own_Below_Threat() returns (result.Own_Below_Threat$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 104} true;
  ...
  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 105} true;
    return;
}
...
implementation {:extern} alt_sep_test() returns (result.alt_sep_test$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 114} true;
    goto label_4;
  ...
  label_6:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 115} true;
    goto label_7;
  ...
  label_8:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 116} true;
    goto label_9;

  label_9:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 118} true;
  ...
  label_15:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 119} true;
  ...
  label_16:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 120} true;
  ...
  label_21:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 122} true;
    alt_sep := 0;
    assume value_is(__ctobpl_const_70, alt_sep);
    goto label_22;

  label_22:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 124} true;
  ...
  label_23:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 141} true;
    result.alt_sep_test$1 := alt_sep;
    assume value_is(__ctobpl_const_95, alt_sep);
    goto label_1;

  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 142} true;
    return;
  ...
  label_27:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 126} true;
  ...
  label_38:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 127} true;
  ...
  label_49:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 128} true;
  ...
  label_50:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 133} true;
  ...
  label_53:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 135} true;
  ...
  label_55:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 138} true;
    alt_sep := 0;
  ...
  label_56:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 136} true;
    alt_sep := 2;
  ...
  label_54:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 134} true;
    alt_sep := 1;
  ...
  label_52:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 132} true;
    alt_sep := 0;
...
implementation {:extern} initialize()
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 50} true;
    assert Positive_RA_Alt_Thresh != 0;
  ...
  label_4:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 51} true;
    assert Positive_RA_Alt_Thresh != 0;
  ...
  label_5:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 52} true;
    assert Positive_RA_Alt_Thresh != 0;
  ...
  label_6:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 53} true;
    assert Positive_RA_Alt_Thresh != 0;
  ...
  label_1:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 54} true;
    return;
}
...
implementation {:extern} main(argc.__1: int, argv.__1: int) returns (result.main$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 148} true;
    goto label_3_true, label_3_false;
  ...
  label_4:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 157} true;
    call initialize();
    goto label_45;

  label_45:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 158} true;
    assert argv != 0;
  ...
  label_50:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 159} true;
    assert argv != 0;
  ...
  label_55:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 160} true;
    assert argv != 0;
  ...
  label_60:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 161} true;
    assert argv != 0;
  ...
  label_65:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 162} true;
    assert argv != 0;
  ...
  label_70:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 163} true;
    assert argv != 0;
  ...
  label_75:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 164} true;
    assert argv != 0;
  ...
  label_80:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 165} true;
    assert argv != 0;
  ...
  label_85:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 166} true;
    assert argv != 0;
  ...
  label_90:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 167} true;
    assert argv != 0;
  ...
  label_95:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 168} true;
    assert argv != 0;
  ...
  label_100:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 169} true;
    assert argv != 0;
  ...
  label_105:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 171} true;
  ...
  label_115:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 172} true;
  ...
  label_7:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 150} true;
  ...
  label_14:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 151} true;
  ...
  label_21:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 152} true;
  ...
  label_28:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 153} true;
  ...
  label_35:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 154} true;
  ...
  label_42:
    assert {:sourcefile ".\v21\tcas.c"} {:sourceline 155} true;
