...
const {:extern} {:model_const "i"} {:sourceFile ".\v1\demo.c"} {:sourceLine 19} unique __ctobpl_const_16: int;
...
const {:extern} {:model_const "p"} {:sourceFile ".\v1\demo.c"} {:sourceLine 28} unique __ctobpl_const_42: int;
...
const {:extern} {:model_const "* p"} {:sourceFile ".\v1\demo.c"} {:sourceLine 28} unique __ctobpl_const_43: int;

const {:extern} {:model_const "* p"} {:sourceFile ".\v1\demo.c"} {:sourceLine 28} unique __ctobpl_const_45: int;

const {:extern} {:model_const "p"} {:sourceFile ".\v1\demo.c"} {:sourceLine 28} unique __ctobpl_const_44: int;

const {:extern} {:model_const "y"} {:sourceFile ".\v1\demo.c"} {:sourceLine 29} unique __ctobpl_const_46: int;

const {:extern} {:model_const "y"} {:sourceFile ".\v1\demo.c"} {:sourceLine 29} unique __ctobpl_const_47: int;

const {:extern} {:model_const "y"} {:sourceFile ".\v1\demo.c"} {:sourceLine 30} unique __ctobpl_const_48: int;
...
implementation {:extern} before(x.__1: int) returns (result.before$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\v1\demo.c"} {:sourceline 18} true;
    goto label_4;
  ...
  label_6:
    assert {:sourcefile ".\v1\demo.c"} {:sourceline 19} true;
    i := 0;
  ...
  label_8:
    assert {:sourcefile ".\v1\demo.c"} {:sourceline 21} true;
    result.before$1 := res;
    assume value_is(__ctobpl_const_11, res);
    goto label_1;

  label_1:
    assert {:sourcefile ".\v1\demo.c"} {:sourceline 22} true;
    return;
  ...
  label_9:
    assert {:sourcefile ".\v1\demo.c"} {:sourceline 20} true;
...
implementation {:extern} tainted(x.__1: int) returns (result.tainted$1: int)
{
  ...
  label_6:
    ...
    Mem_T.INT4 := Mem_T.INT4[y := MINUS_BOTH_PTR_OR_BOTH_INT(Mem_T.INT4[y], 1, 1)];
