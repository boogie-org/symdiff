...
implementation bar() returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v1\inline.c"} {:sourceline 3} true;
    $r := 1;
    $exn := false;
    return;
}
...
implementation foo(p: i32) returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v1\inline.c"} {:sourceline 7} true;
    call $i0 := bar();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v1\inline.c"} {:sourceline 8} true;
    $i1 := $add.i32($i0, p);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_3:
    assert {:sourcefile "v1\inline.c"} {:sourceline 9} true;
    $i3 := $add.i32($i0, p);
    goto $bb0_splitSourceLine_4;
  ...
  $bb0_splitSourceLine_5:
    assert {:sourcefile "v1\inline.c"} {:sourceline 10} true;
    $r := 1;
    $exn := false;
    return;
}
...
implementation main(argc: i32, argv: ref) returns ($r: i32)
{
  ...
  $bb0:
    call $static_init();
    call $init_funcs();
    assert {:sourcefile "v1\inline.c"} {:sourceline 16} true;
    $r := 0;
    $exn := false;
    return;
}
