...
// via ./bin/smack.py v2/test.c -bpl=v2.bpl
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack/share/smack/lib/smack.c", 31, 3} true;
  assume true;
  assume {:sourceloc "/home/vagrant/smack/share/smack/lib/smack.c", 32, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "v2/test.c", 17, 2} true;
  $p0 := x;
  assume {:sourceloc "v2/test.c", 17, 2} true;
  $M.1[$p0] := i;
  assume {:sourceloc "v2/test.c", 18, 1} true;
  $exn := false;
  return;
}
procedure  baz(x: i32)
...
$bb0:
  ...
  assume {:sourceloc "v2/test.c", 7, 2} true;
  $r := x;
  $exn := false;
  return;
}
...
$bb0:
  call {:cexpr "x"} boogie_si_record_ref(x);
  call {:cexpr "w"} boogie_si_record_i32(2);
  call {:cexpr "v"} boogie_si_record_i32(2);
  assume {:sourceloc "v2/test.c", 12, 6} true;
  call $i0 := baz(2);
  call {:cexpr "w"} boogie_si_record_i32($i0);
  assume {:sourceloc "v2/test.c", 13, 2} true;
  $p1 := $add.ref(x, 4);
  assume {:sourceloc "v2/test.c", 13, 2} true;
  $M.1[$p1] := $i0;
  assume {:sourceloc "v2/test.c", 14, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "v2/test.c", 21, 13} true;
  call $p0 := malloc(8);
  assume {:sourceloc "v2/test.c", 21, 13} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "x"} boogie_si_record_ref($p1);
  assume {:sourceloc "v2/test.c", 22, 2} true;
  call foo($p1);
  assume {:sourceloc "v2/test.c", 23, 2} true;
  $p2 := $add.ref($p1, 4);
  assume {:sourceloc "v2/test.c", 23, 2} true;
  $i3 := $M.1[$p2];
  assume {:sourceloc "v2/test.c", 23, 2} true;
  call bar($p1, $i3);
  assume {:sourceloc "v2/test.c", 24, 1} true;
  $r := 0;
  $exn := false;
  return;
}
