...
implementation bar() returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\change.c"} {:sourceline 11} true;
    call $i0 := foo(23, 32);
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\change.c"} {:sourceline 12} true;
    $r := 1;
    $exn := false;
    return;
}
...
implementation foo(p: i32, q: i32) returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\change.c"} {:sourceline 3} true;
    $i0 := $add.i32(q, 1);
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\change.c"} {:sourceline 4} true;
    call $i1 := foo($i0, $i0);
    goto $bb0_splitSourceLine_2;

  $bb0_splitSourceLine_2:
    assert {:sourcefile "v0\change.c"} {:sourceline 5} true;
    $r := p;
    $exn := false;
    return;
}
...
implementation main(argc: i32, argv: ref) returns ($r: i32)
{
  ...
  $bb0:
    call $static_init();
    call $init_funcs();
    assert {:sourcefile "v0\change.c"} {:sourceline 17} true;
    $r := 0;
    $exn := false;
    return;
}
