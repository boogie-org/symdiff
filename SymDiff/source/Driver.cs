  ...
  public class Driver
  {
    public static int Main(string[] args)
    {
      ...
      else if (args[0].Equals("-tryParse"))
      {
        ...
        if (prog == null)
          return 1;
        if (SDiff.Boogie.Process.ResolveAndTypeCheck(prog, args[1]))
          return 1;
        return 0;
      }
    ...
    public static int PrintCallGraph(string filename)
    {
      ...
      if (SDiff.Boogie.Process.ResolveAndTypeCheck(program, filename))
      if (program == null)
      {
    ...
    public static int RecursionCheck(string filename)
    {
      ...
      if (program == null)
        return 1;
      SDiff.Boogie.Process.ResolveAndTypeCheck(program, filename);
