...
namespace SDiff
{
  ...
  {
    public static string MergedProgramOutputFile = null;
    ...
    public const bool InferConfig = false;
    public const bool TraceVerify = false;
    public const bool StripContracts = true ; //we currently have to strip contracts for correctness and (possibly) stability.
