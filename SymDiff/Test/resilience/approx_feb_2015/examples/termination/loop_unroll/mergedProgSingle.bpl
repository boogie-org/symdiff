...
implementation _v1.Iterator(s: int) returns (r: int)
{
  ...
  anon2_LoopHead:
    call i, tmp := _v1.Iterator_loop_anon2_LoopHead(i, tmp);
...
implementation _v1.Iterator_loop_anon2_LoopHead(in_i: int, in_tmp: int) returns (out_i: int, out_tmp: int)
{
  ...
  anon2_LoopBody_dummy:
    call out_i, out_tmp := _v1.Iterator_loop_anon2_LoopHead(out_i, out_tmp);
    return;
...
function {:inline true} MS$_v1.Iterator_loop_anon2_LoopHead$_v2.Iterator_loop_anon4_LoopHead(_v1.in_i: int, 
   ...
   : bool
{
  _v1.in_i == _v2.in_i && _v1.in_tmp == _v2.in_tmp && _v1.a_old == _v2.a_old
   ==> _v1.a_ == _v2.a_ && _v1.out_i == _v2.out_i && _v1.out_tmp == _v2.out_tmp
}
   ...
   returns (_v1.out_i: int, _v1.out_tmp: int, _v2.out_i: int, _v2.out_tmp: int)
{
  ...
  inline$_v1.Iterator_loop_anon2_LoopHead$0$entry:
    ...
    goto inline$_v1.Iterator_loop_anon2_LoopHead$0$anon2_LoopHead;

  inline$_v1.Iterator_loop_anon2_LoopHead$0$anon2_LoopHead:
  ...
  inline$_v1.Iterator_loop_anon2_LoopHead$0$anon2_LoopBody:
    ...
    goto inline$_v1.Iterator_loop_anon2_LoopHead$0$anon2_LoopBody_dummy;

  inline$_v1.Iterator_loop_anon2_LoopHead$0$anon2_LoopBody_dummy:
  ...
  START$1:
    goto inline$_v2.Iterator_loop_anon4_LoopHead$0$Entry;

  inline$_v2.Iterator_loop_anon4_LoopHead$0$Entry:
  ...
  inline$_v2.Iterator_loop_anon4_LoopHead$0$entry:
    ...
    goto inline$_v2.Iterator_loop_anon4_LoopHead$0$anon4_LoopHead;

  inline$_v2.Iterator_loop_anon4_LoopHead$0$anon4_LoopHead:
  ...
  inline$_v2.Iterator_loop_anon4_LoopHead$0$anon5_Else:
    assume {:partition} _v2.a[inline$_v2.Iterator_loop_anon4_LoopHead$0$out_i] != 0;
    goto inline$_v2.Iterator_loop_anon4_LoopHead$0$anon3;

  inline$_v2.Iterator_loop_anon4_LoopHead$0$anon3:
    _v2.a[inline$_v2.Iterator_loop_anon4_LoopHead$0$out_i] := inline$_v2.Iterator_loop_anon4_LoopHead$0$out_tmp;
    inline$_v2.Iterator_loop_anon4_LoopHead$0$out_i := inline$_v2.Iterator_loop_anon4_LoopHead$0$out_i + 1;
    goto inline$_v2.Iterator_loop_anon4_LoopHead$0$anon3_dummy;

  inline$_v2.Iterator_loop_anon4_LoopHead$0$anon3_dummy:
