...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 192));
...
$bb0:
  call {:cexpr "x"} boogie_si_record_i32(x);
  assume {:sourceloc "a.c", 13, 6} true;
  call $i0 := isDiv(x);
  assume {:sourceloc "a.c", 13, 6} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "a.c", 13, 6} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "a.c", 14, 5} true;
  call $i2 := bar(x);
  assume {:sourceloc "a.c", 15, 5} true;
  $i3 := 14;
  goto $bb3;
$bb2:
  assume !(($i1 == 1));
  assume {:sourceloc "a.c", 17, 3} true;
  $i3 := 23;
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 18, 1} true;
  $r := $i3;
  $exn := false;
  return;
}
procedure  isDiv(x: i32)
  returns ($r: i32)
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0;
{
  var $i0: i32;
...
$bb0:
  ...
  assume {:sourceloc "a.c", 22, 10} true;
  call $i0 := foo(121);
  assume {:sourceloc "a.c", 22, 10} true;
  $r := $i0;
  $exn := false;
...
axiom (isDiv == $sub.ref(0, 8));
axiom (llvm.dbg.declare == $sub.ref(0, 16));
axiom (bar == $sub.ref(0, 24));
axiom (foo == $sub.ref(0, 32));
axiom (main == $sub.ref(0, 40));
axiom (__VERIFIER_assume == $sub.ref(0, 48));
axiom (__SMACK_dummy == $sub.ref(0, 56));
axiom (__SMACK_code == $sub.ref(0, 64));
axiom (__VERIFIER_assert == $sub.ref(0, 72));
axiom (__VERIFIER_error == $sub.ref(0, 80));
axiom (exit == $sub.ref(0, 88));
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 96));
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 104));
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 112));
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 120));
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 128));
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 136));
axiom (__VERIFIER_nondet_ulong == $sub.ref(0, 144));
axiom (__VERIFIER_nondet_unsigned_long == $sub.ref(0, 152));
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 160));
axiom (__VERIFIER_nondet == $sub.ref(0, 168));
axiom (__SMACK_decls == $sub.ref(0, 176));
axiom (__SMACK_top_decl == $sub.ref(0, 184));
axiom (llvm.dbg.value == $sub.ref(0, 192));
axiom $and.i1(0,0) == 0;
axiom $and.i1(0,1) == 0;
axiom $and.i1(1,0) == 0;
axiom $and.i1(1,1) == 1;
