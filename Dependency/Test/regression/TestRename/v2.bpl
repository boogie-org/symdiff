...
implementation bar(x: ref, i: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v2/test.c"} {:sourceline 17} true;
    $p0 := x;
    goto $bb0_splitSourceLine_1;
  ...
  $bb0_splitSourceLine_2:
    assert {:sourcefile "v2/test.c"} {:sourceline 18} true;
    $exn := false;
    return;
}
...
implementation baz(x: i32) returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v2/test.c"} {:sourceline 7} true;
    $r := x;
    $exn := false;
    return;
}
...
implementation foo(x: ref)
{
  ...
  $bb0:
    assert {:sourcefile "v2/test.c"} {:sourceline 12} true;
    call $i0 := baz(2);
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v2/test.c"} {:sourceline 13} true;
    $p1 := $add.ref(x, 4);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_3:
    assert {:sourcefile "v2/test.c"} {:sourceline 14} true;
    $exn := false;
    return;
}
...
implementation main(argc: i32, argv: ref) returns ($r: i32)
{
  ...
  $bb0:
    call $static_init();
    call $init_funcs();
    assert {:sourcefile "v2/test.c"} {:sourceline 21} true;
    call $p0 := malloc(8);
    goto $bb0_splitSourceLine_1;
  ...
  $bb0_splitSourceLine_2:
    assert {:sourcefile "v2/test.c"} {:sourceline 22} true;
    call foo($p1);
    goto $bb0_splitSourceLine_3;

  $bb0_splitSourceLine_3:
    assert {:sourcefile "v2/test.c"} {:sourceline 23} true;
    $p2 := $add.ref($p1, 4);
  ...
  $bb0_splitSourceLine_6:
    assert {:sourcefile "v2/test.c"} {:sourceline 24} true;
    $r := 0;
    $exn := false;
    return;
}
