...
// via ../../../bin/smack.py a.c -bpl smacked.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 200));
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 79, 3} true;
  assume true;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 80, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 79, 3} true;
  assume true;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 36, 21} true;
  assert x != $0;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 37, 1} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 79, 3} true;
  assume true;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 31, 21} true;
  assume x != $0;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 32, 1} true;
  $exn := false;
  return;
}
...
{
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 41, 3} true;
  assert false;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 42, 1} true;
  $exn := false;
  return;
}
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  var $p0: ref;
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 75, 10} true;
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 51, 21} true;
  call $i0 := __VERIFIER_nondet_unsigned_char();
  call {:cexpr "x"} boogie_si_record_i8($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 52, 3} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 52, 3} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 52, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 53, 3} true;
  $r := $i0;
  $exn := false;
  return;
}
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 63, 20} true;
  call $i0 := __VERIFIER_nondet_unsigned_int();
  call {:cexpr "x"} boogie_si_record_i32($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 64, 3} true;
  $i1 := $uge.i32($i0, 0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 64, 3} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 64, 3} true;
  call __VERIFIER_assume($i2);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 65, 3} true;
  $r := $i0;
  $exn := false;
  return;
}
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  ...
  var $i2: i32;
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 69, 21} true;
  call $i0 := __VERIFIER_nondet_unsigned_long();
  call {:cexpr "x"} boogie_si_record_i64($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 70, 3} true;
  $i1 := $uge.i64($i0, 0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 70, 3} true;
  $i2 := $zext.i1.i32($i1);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 70, 3} true;
  call __VERIFIER_assume($i2);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 71, 3} true;
  $r := $i0;
  $exn := false;
  return;
}
  ...
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  ...
  var $i3: i32;
$bb0:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 57, 22} true;
  call $i0 := __VERIFIER_nondet_unsigned_short();
  call {:cexpr "x"} boogie_si_record_i16($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 58, 3} true;
  $i1 := $zext.i16.i32($i0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 58, 3} true;
  $i2 := $sge.i32($i1, 0);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 58, 3} true;
  ...
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 58, 3} true;
  call __VERIFIER_assume($i3);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 59, 3} true;
  $r := $i0;
  $exn := false;
  return;
}
procedure  bar(x: i32, y: i32, z: i32, t: i32, m1: ref, m2: ref)
  returns ($r: i32)
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  var $i0: i1;
...
$bb0:
  ...
  call {:cexpr "t"} boogie_si_record_i32(t);
  call {:cexpr "m1"} boogie_si_record_ref(m1);
  call {:cexpr "m2"} boogie_si_record_ref(m2);
  assume {:sourceloc "a.c", 4, 6} true;
  $i0 := $sgt.i32(x, 10);
  assume {:sourceloc "a.c", 4, 6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "a.c", 5, 5} true;
  $p1 := m1;
  assume {:sourceloc "a.c", 5, 5} true;
  $M.1[$p1] := 2;
  assume {:sourceloc "a.c", 6, 5} true;
  $p2 := m2;
  assume {:sourceloc "a.c", 6, 5} true;
  $M.2[$p2] := 3;
  assume {:sourceloc "a.c", 7, 5} true;
  $i3 := 98;
  goto $bb3;
$bb2:
  assume !(($i0 == 1));
  assume {:sourceloc "a.c", 9, 5} true;
  $p4 := $add.ref(m1, 8);
  assume {:sourceloc "a.c", 9, 5} true;
  $M.1[$p4] := 13;
  assume {:sourceloc "a.c", 10, 5} true;
  $p5 := $add.ref(m2, 8);
  assume {:sourceloc "a.c", 10, 5} true;
  $M.2[$p5] := 12;
  assume {:sourceloc "a.c", 11, 5} true;
  $i3 := 72;
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 13, 1} true;
  $r := $i3;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "a.c", 16, 7} true;
  $i0 := $ne.ref(m, $0.ref);
  assume {:sourceloc "a.c", 16, 7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "a.c", 17, 5} true;
  $i1 := 1;
  goto $bb3;
$bb2:
  assume !(($i0 == 1));
  assume {:sourceloc "a.c", 20, 5} true;
  $i1 := 0;
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 22, 1} true;
  $r := $i1;
  $exn := false;
  return;
}
...
$bb0:
  call {:cexpr "x"} boogie_si_record_i32(x);
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 45, 3} true;
  assume false;
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 46, 3} true;
  goto $bb1;
$bb1:
  assume {:sourceloc "/home/vagrant/smack-develop/share/smack/lib/smack.c", 46, 3} true;
  goto $bb1;
...
$bb0:
  call {:cexpr "t"} boogie_si_record_i32(t);
  assume {:sourceloc "a.c", 25, 18} true;
  call $p0 := malloc(256);
  assume {:sourceloc "a.c", 25, 18} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "x"} boogie_si_record_ref($p1);
  assume {:sourceloc "a.c", 26, 18} true;
  call $p2 := malloc(256);
  assume {:sourceloc "a.c", 26, 18} true;
  $p3 := $bitcast.ref.ref($p2);
  call {:cexpr "y"} boogie_si_record_ref($p3);
  assume {:sourceloc "a.c", 27, 16} true;
  call $i4 := bar(13, 12, 23, 64, $p1, $p3);
  call {:cexpr "result"} boogie_si_record_i32($i4);
  assume {:sourceloc "a.c", 29, 3} true;
  call $i5 := baz($p1);
  assume {:sourceloc "a.c", 31, 6} true;
  $i6 := $sgt.i32($i4, 0);
  assume {:sourceloc "a.c", 31, 6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "a.c", 32, 5} true;
  $i7 := 3;
  goto $bb3;
$bb2:
  assume !(($i6 == 1));
  assume {:sourceloc "a.c", 34, 3} true;
  $i7 := 17;
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 36, 1} true;
  $r := $i7;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "a.c", 40, 10} true;
  call $i0 := foo(6);
  assume {:sourceloc "a.c", 40, 10} true;
  $r := $i0;
  $exn := false;
...
procedure  malloc(n: i64)
  returns (r: ref)
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  call r := $alloc(n);
}
axiom (bar == $sub.ref(0, 8));
axiom (llvm.dbg.declare == $sub.ref(0, 16));
axiom (baz == $sub.ref(0, 24));
axiom (foo == $sub.ref(0, 32));
axiom (malloc == $sub.ref(0, 40));
axiom (main == $sub.ref(0, 48));
axiom (__VERIFIER_assume == $sub.ref(0, 56));
axiom (__SMACK_dummy == $sub.ref(0, 64));
axiom (__SMACK_code == $sub.ref(0, 72));
axiom (__VERIFIER_assert == $sub.ref(0, 80));
axiom (__VERIFIER_error == $sub.ref(0, 88));
axiom (exit == $sub.ref(0, 96));
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 104));
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 112));
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 120));
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 128));
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 136));
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 144));
axiom (__VERIFIER_nondet_ulong == $sub.ref(0, 152));
axiom (__VERIFIER_nondet_unsigned_long == $sub.ref(0, 160));
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 168));
axiom (__VERIFIER_nondet == $sub.ref(0, 176));
axiom (__SMACK_decls == $sub.ref(0, 184));
axiom (__SMACK_top_decl == $sub.ref(0, 192));
axiom (llvm.dbg.value == $sub.ref(0, 200));
axiom $and.i1(0,0) == 0;
axiom $and.i1(0,1) == 0;
axiom $and.i1(1,0) == 0;
axiom $and.i1(1,1) == 1;
