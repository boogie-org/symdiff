...
implementation __SMACK_dummy(v: i32)
{
  ...
  $bb0_splitSourceLine_1:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 80} true;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_pointer() returns ($r: ref)
{
  ...
  $bb0:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 75} true;
...
implementation __VERIFIER_nondet_uchar() returns ($r: i8)
{
  ...
  $bb0_splitSourceLine_5:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 53} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_uint() returns ($r: i32)
{
  ...
  $bb0_splitSourceLine_4:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 65} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_ulong() returns ($r: i64)
{
  ...
  $bb0_splitSourceLine_4:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 71} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_ushort() returns ($r: i16)
{
  ...
  $bb0_splitSourceLine_5:
    assert {:sourcefile "v1\/smack.c"} {:sourceline 59} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation a(x: i32) returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v1\a.c"} {:sourceline 2} true;
    $r := x;
    $exn := false;
    return;
}
...
implementation b(x: i32) returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v1\a.c"} {:sourceline 6} true;
    $i0 := $add.i32(x, 21);
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v1\a.c"} {:sourceline 7} true;
    call $i1 := a($i0);
    goto $bb0_splitSourceLine_2;
...
implementation main(argc: i32, argv: ref) returns ($r: i32)
{
  ...
  $bb0:
    call $static_init();
    call $init_funcs();
    assert {:sourcefile "v1\a.c"} {:sourceline 11} true;
    call $i0 := b(121);
    goto $bb0_splitSourceLine_1;
