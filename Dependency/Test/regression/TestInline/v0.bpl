...
axiom $GLOBALS_BOTTOM == $sub.ref(0, 195);
...
implementation __SMACK_dummy(v: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 78} true;
    assume true;
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 79} true;
    $exn := false;
    return;
}
...
implementation __VERIFIER_assert(x: i32)
{
  ...
  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 36} true;
    assert x != $0;
    goto $bb0_splitSourceLine_2;

  $bb0_splitSourceLine_2:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 37} true;
    $exn := false;
    return;
}
...
implementation __VERIFIER_assume(x: i32)
{
  ...
  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 31} true;
    assume x != $0;
    goto $bb0_splitSourceLine_2;

  $bb0_splitSourceLine_2:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 32} true;
    $exn := false;
    return;
}
...
implementation __VERIFIER_error()
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 41} true;
    assert false;
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 42} true;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_pointer() returns ($r: ref)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 74} true;
...
implementation __VERIFIER_nondet_uchar() returns ($r: i8)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 50} true;
    call $i0 := __VERIFIER_nondet_unsigned_char();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 51} true;
    $i1 := $zext.i8.i32($i0);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_5:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 52} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_uint() returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 62} true;
    call $i0 := __VERIFIER_nondet_unsigned_int();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 63} true;
    $i1 := $uge.i32($i0, 0);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_4:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 64} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_ulong() returns ($r: i64)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 68} true;
    call $i0 := __VERIFIER_nondet_unsigned_long();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 69} true;
    $i1 := $uge.i64($i0, 0);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_4:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 70} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation __VERIFIER_nondet_ushort() returns ($r: i16)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 56} true;
    call $i0 := __VERIFIER_nondet_unsigned_short();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 57} true;
    $i1 := $zext.i16.i32($i0);
    goto $bb0_splitSourceLine_2;
  ...
  $bb0_splitSourceLine_5:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 58} true;
    $r := $i0;
    $exn := false;
    return;
}
...
implementation bar() returns ($r: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\inline.c"} {:sourceline 3} true;
    $r := 1;
    $exn := false;
    return;
}
...
implementation exit(x: i32)
{
  ...
  $bb0:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 45} true;
    assume false;
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\/smack.c"} {:sourceline 46} true;
    $exn := false;
    return;
}
...
procedure foo(p: i32) returns ($r: i32);
  modifies $exn;



implementation foo(p: i32) returns ($r: i32)
{
  var $i0: i32;
  var $i1: i32;
  var $i2: i32;
  ...
  $bb0:
    assert {:sourcefile "v0\inline.c"} {:sourceline 7} true;
    call $i0 := bar();
    goto $bb0_splitSourceLine_1;

  $bb0_splitSourceLine_1:
    assert {:sourcefile "v0\inline.c"} {:sourceline 8} true;
    $i1 := $add.i32($i0, p);
    goto $bb0_splitSourceLine_2;

  $bb0_splitSourceLine_2:
    assert {:sourcefile "v0\inline.c"} {:sourceline 9} true;
    call $i2 := printf.ref.i32(.str, $i1);
    goto $bb0_splitSourceLine_3;

  $bb0_splitSourceLine_3:
    assert {:sourcefile "v0\inline.c"} {:sourceline 10} true;
    call $i3 := foo($i1);
    goto $bb0_splitSourceLine_4;

  $bb0_splitSourceLine_4:
    assert {:sourcefile "v0\inline.c"} {:sourceline 11} true;
    $r := $i1;
    $exn := false;
    return;
}
...
implementation main(argc: i32, argv: ref) returns ($r: i32)
{
  ...
  $bb0:
    call $static_init();
    call $init_funcs();
    assert {:sourcefile "v0\inline.c"} {:sourceline 17} true;
    $r := 0;
    $exn := false;
    return;
}
...
procedure printf.ref.i32($p0: ref, $i1: i32) returns (r: i32);



axiom .str == $sub.ref(0, 3);

axiom bar == $sub.ref(0, 11);

axiom foo == $sub.ref(0, 19);

axiom llvm.dbg.declare == $sub.ref(0, 27);

axiom printf == $sub.ref(0, 35);

axiom main == $sub.ref(0, 43);

axiom __VERIFIER_assume == $sub.ref(0, 51);

axiom __SMACK_dummy == $sub.ref(0, 59);

axiom __SMACK_code == $sub.ref(0, 67);

axiom __VERIFIER_assert == $sub.ref(0, 75);

axiom __VERIFIER_error == $sub.ref(0, 83);

axiom exit == $sub.ref(0, 91);

axiom __VERIFIER_nondet_uchar == $sub.ref(0, 99);

axiom __VERIFIER_nondet_unsigned_char == $sub.ref(0, 107);

axiom __VERIFIER_nondet_ushort == $sub.ref(0, 115);

axiom __VERIFIER_nondet_unsigned_short == $sub.ref(0, 123);

axiom __VERIFIER_nondet_uint == $sub.ref(0, 131);

axiom __VERIFIER_nondet_unsigned_int == $sub.ref(0, 139);

axiom __VERIFIER_nondet_ulong == $sub.ref(0, 147);

axiom __VERIFIER_nondet_unsigned_long == $sub.ref(0, 155);

axiom __VERIFIER_nondet_pointer == $sub.ref(0, 163);

axiom __VERIFIER_nondet == $sub.ref(0, 171);

axiom __SMACK_decls == $sub.ref(0, 179);

axiom __SMACK_top_decl == $sub.ref(0, 187);

axiom llvm.dbg.value == $sub.ref(0, 195);
