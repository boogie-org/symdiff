...
const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 3} unique __ctobpl_const_1: int;

const {:extern} {:model_const "x"} {:sourceFile "source\testtaint.c"} {:sourceLine 3} unique __ctobpl_const_2: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 4} unique __ctobpl_const_3: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 9} unique __ctobpl_const_4: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 10} unique __ctobpl_const_5: int;

const {:extern} {:model_const "result.TestTaintMiddle"} {:sourceFile "source\testtaint.c"} {:sourceLine 16} unique __ctobpl_const_11: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 17} unique __ctobpl_const_12: int;

const {:extern} {:model_const "x"} {:sourceFile "source\testtaint.c"} {:sourceLine 16} unique __ctobpl_const_8: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 16} unique __ctobpl_const_10: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 11} unique __ctobpl_const_7: int;

const {:extern} {:model_const "x"} {:sourceFile "source\testtaint.c"} {:sourceLine 16} unique __ctobpl_const_9: int;

const {:extern} {:model_const "y"} {:sourceFile "source\testtaint.c"} {:sourceLine 10} unique __ctobpl_const_6: int;
...
implementation {:extern} TestTaintBottom(x.__1: int) returns (result.TestTaintBottom$1: int)
{
...
implementation {:extern} TestTaintMiddle(x.__1: int) returns (result.TestTaintMiddle$1: int)
{
  var {:extern} havoc_stringTemp: int;
  var {:extern} condVal: int;
  ...
  label_1:
    assert {:sourcefile "source\testtaint.c"} {:sourceline 12} true;
    return;
}
...
implementation {:extern} TestTaintTop(x.__1: int) returns (result.TestTaintTop$1: int)
{
  var {:extern} havoc_stringTemp: int;
  var {:extern} condVal: int;
  var {:extern} result.TestTaintMiddle$2: int;
  var {:extern} x: int;
  var {:extern} y: int;
  var {:extern} tempBoogie0: int;
  var {:extern} tempBoogie1: int;
