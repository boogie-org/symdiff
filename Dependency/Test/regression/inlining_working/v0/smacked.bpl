...
$bb0:
  ...
  assume {:sourceloc "a.c", 4, 3} true;
  $M.1[s] := 12;
  assume {:sourceloc "a.c", 5, 3} true;
  $r := s;
  $exn := false;
  return;
}
...
$bb1:
  ...
  call $p1 := bar(s);
  assume {:sourceloc "a.c", 11, 3} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "a.c", 9, 6} true;
  assume !(($i0 == 1));
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 12, 3} true;
  $r := s;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "a.c", 16, 18} true;
  call $p0 := malloc(256);
  assume {:sourceloc "a.c", 16, 18} true;
  ...
  call $p2 := foo($p1);
  assume {:sourceloc "a.c", 18, 3} true;
  $r := 0;
  $exn := false;
  return;
}
