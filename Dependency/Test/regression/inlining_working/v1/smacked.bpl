...
$bb0:
  ...
  assume {:sourceloc "a.c", 4, 7} true;
  $i0 := $ne.ref(s, $0.ref);
  assume {:sourceloc "a.c", 4, 7} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i0 == 1);
  assume {:sourceloc "a.c", 5, 4} true;
  $M.1[s] := 12;
  assume {:sourceloc "a.c", 6, 3} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "a.c", 4, 7} true;
  assume !(($i0 == 1));
...
$bb0:
  call {:cexpr "s"} boogie_si_record_ref(s);
  assume {:sourceloc "a.c", 12, 5} true;
  call $p0 := bar(s);
  assume {:sourceloc "a.c", 14, 3} true;
  $r := s;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "a.c", 18, 18} true;
  call $p0 := malloc(256);
  assume {:sourceloc "a.c", 18, 18} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "m"} boogie_si_record_ref($p1);
  assume {:sourceloc "a.c", 19, 3} true;
  call $p2 := foo($p1);
  assume {:sourceloc "a.c", 20, 3} true;
  $r := 0;
  $exn := false;
  return;
}
