...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 208));
...
$bb0:
  ...
  assume {:sourceloc "a.c", 15, 3} true;
  $p0 := m;
  assume {:sourceloc "a.c", 15, 3} true;
  $i1 := $M.1[$p0];
  assume {:sourceloc "a.c", 15, 3} true;
...
$bb0:
  call {:cexpr "x"} boogie_si_record_i32(x);
  call {:cexpr "m"} boogie_si_record_ref(m);
  assume {:sourceloc "a.c", 2, 3} true;
  $i0 := $sext.i32.i64(x);
  assume {:sourceloc "a.c", 2, 3} true;
  $p1 := $add.ref(m, $mul.ref($i0, 4));
  assume {:sourceloc "a.c", 2, 3} true;
  $r := $p1;
  $exn := false;
  return;
...
$bb0:
  call {:cexpr "x"} boogie_si_record_i32(x);
  assume {:sourceloc "a.c", 19, 19} true;
  call $p0 := malloc(256);
  assume {:sourceloc "a.c", 19, 19} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "m"} boogie_si_record_ref($p1);
  assume {:sourceloc "a.c", 20, 6} true;
  call $i2 := isSmarter(x, $p1);
  assume {:sourceloc "a.c", 20, 6} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "a.c", 20, 6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "a.c", 21, 5} true;
  call $i4 := bar(x, $p1);
  assume {:sourceloc "a.c", 22, 5} true;
  $i5 := 14;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "a.c", 24, 3} true;
  $i5 := 23;
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 25, 1} true;
  $r := $i5;
  $exn := false;
  return;
}
procedure  isSmarter(x: i32, m1: ref)
  returns ($r: i32)
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1;
{
  var $i0: i1;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "a.c", 7, 10} true;
  call $p3 := doSome(x, m1);
  call {:cexpr "m1"} boogie_si_record_ref($p3);
  assume {:sourceloc "a.c", 8, 5} true;
  $i4 := 1;
  goto $bb3;
$bb2:
  assume !(($i2 == 1));
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "a.c", 12, 1} true;
  $r := $i4;
  $exn := false;
  return;
}
...
$bb0:
  ...
  call $p0 := doSome(0, $0.ref);
  assume {:sourceloc "a.c", 30, 10} true;
  call $i1 := foo(121);
  assume {:sourceloc "a.c", 30, 10} true;
  $r := $i1;
  $exn := false;
...
axiom (doSome == $sub.ref(0, 8));
axiom (llvm.dbg.declare == $sub.ref(0, 16));
axiom (isSmarter == $sub.ref(0, 24));
axiom (bar == $sub.ref(0, 32));
axiom (foo == $sub.ref(0, 40));
axiom (malloc == $sub.ref(0, 48));
axiom (main == $sub.ref(0, 56));
axiom (__VERIFIER_assume == $sub.ref(0, 64));
axiom (__SMACK_dummy == $sub.ref(0, 72));
axiom (__SMACK_code == $sub.ref(0, 80));
axiom (__VERIFIER_assert == $sub.ref(0, 88));
axiom (__VERIFIER_error == $sub.ref(0, 96));
axiom (exit == $sub.ref(0, 104));
axiom (__VERIFIER_nondet_uchar == $sub.ref(0, 112));
axiom (__VERIFIER_nondet_unsigned_char == $sub.ref(0, 120));
axiom (__VERIFIER_nondet_ushort == $sub.ref(0, 128));
axiom (__VERIFIER_nondet_unsigned_short == $sub.ref(0, 136));
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 144));
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 152));
axiom (__VERIFIER_nondet_ulong == $sub.ref(0, 160));
axiom (__VERIFIER_nondet_unsigned_long == $sub.ref(0, 168));
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 176));
axiom (__VERIFIER_nondet == $sub.ref(0, 184));
axiom (__SMACK_decls == $sub.ref(0, 192));
axiom (__SMACK_top_decl == $sub.ref(0, 200));
axiom (llvm.dbg.value == $sub.ref(0, 208));
axiom $and.i1(0,0) == 0;
axiom $and.i1(0,1) == 0;
axiom $and.i1(1,0) == 0;
axiom $and.i1(1,1) == 1;
