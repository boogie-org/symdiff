...
const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 27} unique __ctobpl_const_41: int;
...
const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 29} unique __ctobpl_const_45: int;

const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 29} unique __ctobpl_const_44: int;

const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 30} unique __ctobpl_const_46: int;
