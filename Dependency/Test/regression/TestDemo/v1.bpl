...
const {:extern} {:model_const "i"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 19} unique __ctobpl_const_9: int;

const {:extern} {:model_const "i"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 19} unique __ctobpl_const_10: int;

const {:extern} {:model_const "res"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 18} unique __ctobpl_const_8: int;

const {:extern} {:model_const "x"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 35} unique __ctobpl_const_2: int;

const {:extern} {:model_const "q"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 41} unique __ctobpl_const_3: int;

const {:extern} {:model_const "y"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 41} unique __ctobpl_const_4: int;

const {:extern} {:model_const "q"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 42} unique __ctobpl_const_5: int;

const {:extern} {:model_const "x"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 34} unique __ctobpl_const_1: int;

const {:extern} {:model_const "* q"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 42} unique __ctobpl_const_6: int;

const {:extern} {:model_const "y"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 43} unique __ctobpl_const_7: int;

const {:extern} {:model_const "res"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 21} unique __ctobpl_const_11: int;

const {:extern} {:model_const "x"} {:sourceFile "e:\symdiff_codeplex\symdiff\dependency\test\regression\testdemo\v1\demo.c"} {:sourceLine 20} unique __ctobpl_const_12: int;
