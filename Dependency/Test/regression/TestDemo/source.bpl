...
const {:extern} {:model_const "i"} {:sourceFile ".\source\demo.c"} {:sourceLine 0} unique __ctobpl_const_16: int;
...
implementation {:extern} before(x.__1: int) returns (result.before$1: int)
{
  ...
  label_13:
    assert {:sourcefile ".\source\demo.c"} {:sourceline 0} true;
    i := PLUS(i, 1, 1);
...
implementation {:extern} main() returns (result.main$1: int)
{
  ...
  label_3:
    assert {:sourcefile ".\source\demo.c"} {:sourceline 2} true;
    goto label_4;
