...
const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceLine 29} unique __ctobpl_const_43: int;
...
const {:extern} {:model_const "p"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceLine 28} unique __ctobpl_const_41: int;

const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceLine 29} unique __ctobpl_const_42: int;
...
const {:extern} {:model_const "y"} {:sourceFile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceLine 30} unique __ctobpl_const_44: int;
...
implementation {:extern} main() returns (result.main$1: int)
{
  ...
  label_3:
    assert {:sourcefile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceline 2} true;
    goto label_4;
...
implementation {:extern} tainted(x.__1: int) returns (result.tainted$1: int)
{
  ...
  label_6:
    ...
    tempBoogie0 := PLUS(Mem_T.INT4[y], 1, 1);
    Mem_T.INT4 := Mem_T.INT4[y := tempBoogie0];
    goto label_7;

  label_7:
    assert {:sourcefile "c:\users\t-nisebb\documents\symdiff.src\dependency\test\regression\testdemo\source\demo.c"} {:sourceline 28} true;
