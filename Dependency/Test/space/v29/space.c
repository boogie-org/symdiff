...
kwdsinit(void)
{
	...
	strcpy(Keywords[84], "P1_ET");
	strcpy(Keywords[85], "P2_ET");
	strcpy(Keywords[86], "Q1_ET");
	strcpy(Keywords[87], "Q2_ET");


	strcpy(Keywords[88], "UNIFORM");


	strcpy(Keywords[89], "P1_EP");
	strcpy(Keywords[90], "P2_EP");
	strcpy(Keywords[91], "Q1_EP");
	strcpy(Keywords[92], "Q2_EP");
