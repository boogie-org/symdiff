...
implementation {:extern} dodash(delim.__1: int, src.__1: int, i.__1: int, dest.__1: int, j.__1: int, maxset.__1: int)
{
  ...
  label_6_head:
    call $addstr.arg.1$4$, escjunk, $isalnum.arg.1$7$, junk, k, result.addstr$2, result.addstr$3, result.addstr$5, result.addstr$8, result.addstr$9, result.esc$1, result.isalnum$6 := dodash_loop_label_6_head($addstr.arg.1$4$, delim, dest, escjunk, i, $isalnum.arg.1$7$, j, junk, k, maxset, result.addstr$2, result.addstr$3, result.addstr$5, result.addstr$8, result.addstr$9, result.esc$1, result.isalnum$6, src);
  ...
  label_40_head:
    call junk, k, result.addstr$8 := dodash_loop_label_40_head(dest, i, j, junk, k, maxset, result.addstr$8, src);
...
implementation dodash_loop_label_40_head(in_dest: int, in_i: int, in_j: int, in_junk: int, in_k: int, in_maxset: int, in_result.addstr$8: int, in_src: int) returns (out_junk: int, out_k: int, out_result.addstr$8: int)
{
  ...
  label_40_false:
    ...
    assume value_is(__ctobpl_const_161, out_k);
    assume value_is(__ctobpl_const_162, in_src);
    assume value_is(__ctobpl_const_163, in_i);
    assume value_is(__ctobpl_const_164, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_165, Mem_T.CHAR[PLUS(in_src, 1, PLUS(Mem_T.INT4[in_i], 1, 1))]);
    out_junk, out_k, out_result.addstr$8 := in_junk, in_k, in_result.addstr$8;
    return;

  label_46:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 119} true;
    assume value_is(__ctobpl_const_180, out_k);
  ...
  label_45:
    ...
    assume value_is(__ctobpl_const_178, out_junk);
    assume value_is(__ctobpl_const_179, out_result.addstr$8);
    goto label_46;

  label_42:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 121} true;
    call out_result.addstr$8 := addstr(out_k, in_dest, in_j, in_maxset);
    assume value_is(__ctobpl_const_170, out_k);
    assume value_is(__ctobpl_const_171, in_dest);
    assume value_is(__ctobpl_const_172, in_j);
    assume value_is(__ctobpl_const_173, in_maxset);
  ...
  label_46_dummy:
    call {:si_unique_call 1} out_junk, out_k, out_result.addstr$8 := dodash_loop_label_40_head(in_dest, in_i, in_j, out_junk, out_k, in_maxset, out_result.addstr$8, in_src);
    return;
...
procedure dodash_loop_label_40_head(in_dest: int, in_i: int, in_j: int, in_junk: int, in_k: int, in_maxset: int, in_result.addstr$8: int, in_src: int) returns (out_junk: int, out_k: int, out_result.addstr$8: int);



implementation dodash_loop_label_6_head(in_$addstr.arg.1$4$: int, in_delim: int, in_dest: int, in_escjunk: int, in_i: int, in_$isalnum.arg.1$7$: int, in_j: int, in_junk: int, in_k: int, in_maxset: int, in_result.addstr$2: int, in_result.addstr$3: int, in_result.addstr$5: int, in_result.addstr$8: int, in_result.addstr$9: int, in_result.esc$1: int, in_result.isalnum$6: int, in_src: int) returns (out_$addstr.arg.1$4$: int, out_escjunk: int, out_$isalnum.arg.1$7$: int, out_junk: int, out_k: int, out_result.addstr$2: int, out_result.addstr$3: int, out_result.addstr$5: int, out_result.addstr$8: int, out_result.addstr$9: int, out_result.esc$1: int, out_result.isalnum$6: int)
{

  entry:
    out_$addstr.arg.1$4$, out_escjunk, out_$isalnum.arg.1$7$, out_junk, out_k, out_result.addstr$2, out_result.addstr$3, out_result.addstr$5, out_result.addstr$8, out_result.addstr$9, out_result.esc$1, out_result.isalnum$6 := in_$addstr.arg.1$4$, in_escjunk, in_$isalnum.arg.1$7$, in_junk, in_k, in_result.addstr$2, in_result.addstr$3, in_result.addstr$5, in_result.addstr$8, in_result.addstr$9, in_result.esc$1, in_result.isalnum$6;
    goto label_6_head;
  ...
  label_18:
    ...
    assume value_is(__ctobpl_const_220, in_i);
    assume value_is(__ctobpl_const_221, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_222, in_i);
    assume value_is(__ctobpl_const_223, Mem_T.INT4[in_i]);
    goto label_18_dummy;

  label_29:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 114} true;
    out_junk := out_result.addstr$5;
    assume value_is(__ctobpl_const_187, out_junk);
    assume value_is(__ctobpl_const_188, out_result.addstr$5);
    goto label_18;

  label_47:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 126} true;
    out_junk := out_result.addstr$9;
    assume value_is(__ctobpl_const_154, out_junk);
    assume value_is(__ctobpl_const_155, out_result.addstr$9);
    goto label_18;
  ...
  label_41:
    ...
    assume value_is(__ctobpl_const_168, in_i);
    assume value_is(__ctobpl_const_169, Mem_T.INT4[in_i]);
    goto label_18;

  label_24:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 112} true;
    out_junk := out_result.addstr$3;
    assume value_is(__ctobpl_const_202, out_junk);
    assume value_is(__ctobpl_const_203, out_result.addstr$3);
    goto label_18;

  label_17:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 109} true;
    out_junk := out_result.addstr$2;
    assume value_is(__ctobpl_const_218, out_junk);
    assume value_is(__ctobpl_const_219, out_result.addstr$2);
    goto label_18;

  label_14:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 109} true;
    call out_result.addstr$2 := addstr(out_escjunk, in_dest, in_j, in_maxset);
    assume value_is(__ctobpl_const_210, out_escjunk);
    assume value_is(__ctobpl_const_211, in_dest);
    assume value_is(__ctobpl_const_212, in_j);
    assume value_is(__ctobpl_const_213, in_maxset);
    assume value_is(__ctobpl_const_214, out_escjunk);
    assume value_is(__ctobpl_const_215, in_dest);
    assume value_is(__ctobpl_const_216, in_j);
    assume value_is(__ctobpl_const_217, in_maxset);
    goto label_17;

  label_13:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 108} true;
    out_escjunk := out_result.esc$1;
    assume value_is(__ctobpl_const_208, out_escjunk);
    assume value_is(__ctobpl_const_209, out_result.esc$1);
    goto label_14;

  label_10:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 108} true;
    call out_result.esc$1 := esc(in_src, in_i);
    assume value_is(__ctobpl_const_204, in_src);
    assume value_is(__ctobpl_const_205, in_i);
    assume value_is(__ctobpl_const_206, in_src);
    assume value_is(__ctobpl_const_207, in_i);
    goto label_13;
  ...
  label_21:
    ...
    assume value_is(__ctobpl_const_194, out_$addstr.arg.1$4$);
    assume value_is(__ctobpl_const_195, in_dest);
    assume value_is(__ctobpl_const_196, in_j);
    assume value_is(__ctobpl_const_197, in_maxset);
    assume value_is(__ctobpl_const_198, out_$addstr.arg.1$4$);
  ...
  label_20:
    ...
    assume value_is(__ctobpl_const_189, out_$addstr.arg.1$4$);
    assume value_is(__ctobpl_const_190, in_src);
    assume value_is(__ctobpl_const_191, in_i);
    assume value_is(__ctobpl_const_192, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_193, Mem_T.CHAR[PLUS(in_src, 1, Mem_T.INT4[in_i])]);
    goto label_21;
  ...
  label_40_head:
    call out_junk, out_k, out_result.addstr$8 := dodash_loop_label_40_head(in_dest, in_i, in_j, out_junk, out_k, in_maxset, out_result.addstr$8, in_src);
    goto label_40_head_last;
  ...
  label_39:
    ...
    assume value_is(__ctobpl_const_156, out_k);
    assume value_is(__ctobpl_const_157, in_src);
    assume value_is(__ctobpl_const_158, in_i);
    assume value_is(__ctobpl_const_159, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_160, Mem_T.CHAR[PLUS(in_src, 1, MINUS_BOTH_PTR_OR_BOTH_INT(Mem_T.INT4[in_i], 1, 1))]);
    goto label_40;
  ...
  label_38_true:
    ...
    assume value_is(__ctobpl_const_143, Mem_T.CHAR[PLUS(in_src, 1, MINUS_BOTH_PTR_OR_BOTH_INT(Mem_T.INT4[in_i], 1, 1))]);
    ...
    assume value_is(__ctobpl_const_147, Mem_T.CHAR[PLUS(in_src, 1, PLUS(Mem_T.INT4[in_i], 1, 1))]);
    goto label_39;
  ...
  label_35:
    ...
    assume value_is(__ctobpl_const_148, in_dest);
    assume value_is(__ctobpl_const_149, in_j);
    assume value_is(__ctobpl_const_150, in_maxset);
    assume value_is(__ctobpl_const_151, in_dest);
    assume value_is(__ctobpl_const_152, in_j);
    assume value_is(__ctobpl_const_153, in_maxset);
    goto label_47;
  ...
  label_26:
    ...
    assume value_is(__ctobpl_const_181, in_dest);
    assume value_is(__ctobpl_const_182, in_j);
    assume value_is(__ctobpl_const_183, in_maxset);
    assume value_is(__ctobpl_const_184, in_dest);
    assume value_is(__ctobpl_const_185, in_j);
    assume value_is(__ctobpl_const_186, in_maxset);
    goto label_29;
  ...
  label_18_dummy:
    call {:si_unique_call 1} out_$addstr.arg.1$4$, out_escjunk, out_$isalnum.arg.1$7$, out_junk, out_k, out_result.addstr$2, out_result.addstr$3, out_result.addstr$5, out_result.addstr$8, out_result.addstr$9, out_result.esc$1, out_result.isalnum$6 := dodash_loop_label_6_head(out_$addstr.arg.1$4$, in_delim, in_dest, out_escjunk, in_i, out_$isalnum.arg.1$7$, in_j, out_junk, out_k, in_maxset, out_result.addstr$2, out_result.addstr$3, out_result.addstr$5, out_result.addstr$8, out_result.addstr$9, out_result.esc$1, out_result.isalnum$6, in_src);
    return;
...
implementation locate_loop_label_7_head(in_c: int, in_flag: int, in_i: int, in_offset: int, in_pat: int) returns (out_flag: int, out_i: int)
{
  ...
  label_7_false:
    ...
    assume value_is(__ctobpl_const_356, in_offset);
  ...
  label_10:
    ...
    assume value_is(__ctobpl_const_363, out_i);
    assume value_is(__ctobpl_const_364, out_i);
    goto label_10_dummy;

  label_9_false:
    assume !INT_EQ(in_c, Mem_T.CHAR[PLUS(in_pat, 1, out_i)]);
    assume value_is(__ctobpl_const_359, in_c);
    assume value_is(__ctobpl_const_360, in_pat);
    assume value_is(__ctobpl_const_361, out_i);
    assume value_is(__ctobpl_const_362, Mem_T.CHAR[PLUS(in_pat, 1, out_i)]);
    goto label_10;
  ...
  label_12:
    ...
    assume value_is(__ctobpl_const_367, in_offset);
    goto label_12_dummy;

  label_11:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 319} true;
    out_flag := 1;
    assume value_is(__ctobpl_const_365, out_flag);
    goto label_12;
...
implementation makepat_loop_label_16_head(in_arg: int, in_delim: int, in_done: int, in_escjunk: int, in_getres: int, in_i: int, in_$in_set_2.arg.1$7$: int, in_j: int, in_junk: int, in_lastj: int, in_lj: int, in_pat: int, in_result.addstr$2: int, in_result.addstr$3: int, in_result.addstr$4: int, in_result.addstr$8: int, in_result.addstr$10: int, in_result.esc$9: int, in_result.getccl$5: int, in_result.in_set_2$6: int, in_start: int) returns (out_done: int, out_escjunk: int, out_getres: int, out_$in_set_2.arg.1$7$: int, out_junk: int, out_lastj: int, out_lj: int, out_result.addstr$2: int, out_result.addstr$3: int, out_result.addstr$4: int, out_result.addstr$8: int, out_result.addstr$10: int, out_result.esc$9: int, out_result.getccl$5: int, out_result.in_set_2$6: int)
{
  ...
  label_16_true:
    assume out_done != 0;
    assume value_is(__ctobpl_const_398, out_done);
    out_done, out_escjunk, out_getres, out_$in_set_2.arg.1$7$, out_junk, out_lastj, out_lj, out_result.addstr$2, out_result.addstr$3, out_result.addstr$4, out_result.addstr$8, out_result.addstr$10, out_result.esc$9, out_result.getccl$5, out_result.in_set_2$6 := in_done, in_escjunk, in_getres, in_$in_set_2.arg.1$7$, in_junk, in_lastj, in_lj, in_result.addstr$2, in_result.addstr$3, in_result.addstr$4, in_result.addstr$8, in_result.addstr$10, in_result.esc$9, in_result.getccl$5, in_result.in_set_2$6;
    Mem_T.INT4 := old(Mem_T.INT4);
    return;
  ...
  label_39:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 233} true;
    Mem_T.INT4 := Mem_T.INT4[in_i := PLUS(Mem_T.INT4[in_i], 1, 1)];
    assume value_is(__ctobpl_const_500, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_501, Mem_T.INT4[in_i]);
    goto label_39_dummy;

  label_38_false:
    assume out_done == 0;
    assume value_is(__ctobpl_const_499, out_done);
    goto label_39;
  ...
  label_37:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 231} true;
    out_lastj := out_lj;
    assume value_is(__ctobpl_const_497, out_lastj);
    assume value_is(__ctobpl_const_498, out_lj);
    goto label_38;

  label_80:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 229} true;
    out_junk := out_result.addstr$10;
    assume value_is(__ctobpl_const_449, out_junk);
    assume value_is(__ctobpl_const_450, out_result.addstr$10);
    goto label_37;
  ...
  label_68:
    ...
    assume value_is(__ctobpl_const_461, Mem_T.INT4[in_j]);
    assume value_is(__ctobpl_const_462, out_lastj);
    assume value_is(__ctobpl_const_463, in_pat);
    assume value_is(__ctobpl_const_464, Mem_T.INT4[in_j]);
    assume value_is(__ctobpl_const_465, out_lastj);
    goto label_37;

  label_71:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 221} true;
    out_done := 1;
    assume value_is(__ctobpl_const_466, out_done);
    goto label_37;

  label_57:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 215} true;
    out_done := LIFT(INT_EQ(out_getres, 0));
    assume value_is(__ctobpl_const_477, out_done);
    assume value_is(__ctobpl_const_478, out_getres);
    goto label_37;
  ...
  label_51:
    ...
    assume value_is(__ctobpl_const_484, out_result.addstr$4);
    goto label_37;
  ...
  label_45:
    ...
    assume value_is(__ctobpl_const_490, out_result.addstr$3);
    goto label_37;
  ...
  label_36:
    ...
    assume value_is(__ctobpl_const_496, out_result.addstr$2);
    goto label_37;
  ...
  label_30:
    ...
    assume value_is(__ctobpl_const_406, out_lj);
    assume value_is(__ctobpl_const_407, Mem_T.INT4[in_j]);
    goto label_31;
  ...
  label_17_true:
    ...
    assume value_is(__ctobpl_const_402, in_delim);
    goto label_29;
  ...
  label_41_true:
    ...
    assume value_is(__ctobpl_const_415, in_start);
    goto label_42;
  ...
  label_47_true:
    ...
    assume value_is(__ctobpl_const_421, Mem_T.CHAR[PLUS(in_arg, 1, PLUS(Mem_T.INT4[in_i], 1, 1))]);
    assume value_is(__ctobpl_const_422, in_delim);
    goto label_48;
  ...
  label_56:
    ...
    assume value_is(__ctobpl_const_475, out_getres);
    assume value_is(__ctobpl_const_476, out_result.getccl$5);
    goto label_57;

  label_53:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 214} true;
    call out_result.getccl$5 := getccl(in_arg, in_i, in_pat, in_j);
    assume value_is(__ctobpl_const_467, in_arg);
    assume value_is(__ctobpl_const_468, Mem_T.INT4[in_i]);
  ...
  label_67_true:
    ...
    assume value_is(__ctobpl_const_459, out_result.in_set_2$6);
    goto label_71;
  ...
  label_64:
    ...
    assume value_is(__ctobpl_const_458, out_$in_set_2.arg.1$7$);
    goto label_67;
  ...
  label_63:
    ...
    assume value_is(__ctobpl_const_453, out_$in_set_2.arg.1$7$);
    assume value_is(__ctobpl_const_454, in_pat);
    assume value_is(__ctobpl_const_455, out_lj);
    assume value_is(__ctobpl_const_456, Mem_T.CHAR[PLUS(in_pat, 1, out_lj)]);
    goto label_64;

  label_62:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 219} true;
    out_lj := out_lastj;
    assume value_is(__ctobpl_const_451, out_lj);
    assume value_is(__ctobpl_const_452, out_lastj);
    goto label_63;

  label_61_true:
    assume INT_LT(in_start, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_429, in_start);
  ...
  label_77:
    ...
    assume value_is(__ctobpl_const_443, out_escjunk);
    assume value_is(__ctobpl_const_444, in_pat);
    assume value_is(__ctobpl_const_445, Mem_T.INT4[in_j]);
    assume value_is(__ctobpl_const_446, out_escjunk);
    assume value_is(__ctobpl_const_447, in_pat);
    assume value_is(__ctobpl_const_448, Mem_T.INT4[in_j]);
    goto label_80;

  label_76:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 228} true;
    out_escjunk := out_result.esc$9;
    assume value_is(__ctobpl_const_441, out_escjunk);
    assume value_is(__ctobpl_const_442, out_result.esc$9);
    goto label_77;

  label_73:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 228} true;
    call out_result.esc$9 := esc(in_arg, in_i);
    assume value_is(__ctobpl_const_437, in_arg);
    assume value_is(__ctobpl_const_438, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_439, in_arg);
    assume value_is(__ctobpl_const_440, Mem_T.INT4[in_i]);
    goto label_76;

  label_72:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 227} true;
    out_junk := out_result.addstr$8;
    assume value_is(__ctobpl_const_435, out_junk);
    assume value_is(__ctobpl_const_436, out_result.addstr$8);
    goto label_73;

  label_58:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 227} true;
    call out_result.addstr$8 := addstr(99, in_pat, in_j, 100);
    assume value_is(__ctobpl_const_431, in_pat);
    assume value_is(__ctobpl_const_432, Mem_T.INT4[in_j]);
    assume value_is(__ctobpl_const_433, in_pat);
    assume value_is(__ctobpl_const_434, Mem_T.INT4[in_j]);
    goto label_72;
...
implementation makesub_loop_label_10_head(in_arg: int, in_delim: int, in_escjunk: int, in_i: int, in_j: int, in_junk: int, in_result.addstr$2: int, in_result.addstr$4: int, in_result.esc$3: int, in_sub: int) returns (out_escjunk: int, out_junk: int, out_result.addstr$2: int, out_result.addstr$4: int, out_result.esc$3: int)
{
  ...
  label_10_false:
    assume !INT_NEQ(Mem_T.CHAR[PLUS(in_arg, 1, Mem_T.INT4[in_i])], in_delim);
    assume value_is(__ctobpl_const_522, in_arg);
    assume value_is(__ctobpl_const_523, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_524, Mem_T.CHAR[PLUS(in_arg, 1, Mem_T.INT4[in_i])]);
    assume value_is(__ctobpl_const_525, in_delim);
    out_escjunk, out_junk, out_result.addstr$2, out_result.addstr$4, out_result.esc$3 := in_escjunk, in_junk, in_result.addstr$2, in_result.addstr$4, in_result.esc$3;
    Mem_T.INT4 := old(Mem_T.INT4);
    return;
  ...
  label_21:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 278} true;
    Mem_T.INT4 := Mem_T.INT4[in_i := PLUS(Mem_T.INT4[in_i], 1, 1)];
    assume value_is(__ctobpl_const_570, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_571, Mem_T.INT4[in_i]);
    goto label_21_dummy;

  label_26:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 276} true;
    out_junk := out_result.addstr$4;
    assume value_is(__ctobpl_const_562, out_junk);
    assume value_is(__ctobpl_const_563, out_result.addstr$4);
    goto label_21;
  ...
  label_20:
    ...
    assume value_is(__ctobpl_const_569, out_result.addstr$2);
    goto label_21;
  ...
  label_13_true:
    ...
    assume value_is(__ctobpl_const_547, in_arg);
    assume value_is(__ctobpl_const_548, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_549, Mem_T.CHAR[PLUS(in_arg, 1, Mem_T.INT4[in_i])]);
    goto label_17;
  ...
  label_23:
    ...
    assume value_is(__ctobpl_const_556, out_escjunk);
    assume value_is(__ctobpl_const_557, in_sub);
    assume value_is(__ctobpl_const_558, Mem_T.INT4[in_j]);
    assume value_is(__ctobpl_const_559, out_escjunk);
    assume value_is(__ctobpl_const_560, in_sub);
    assume value_is(__ctobpl_const_561, Mem_T.INT4[in_j]);
    goto label_26;

  label_22:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 275} true;
    out_escjunk := out_result.esc$3;
    assume value_is(__ctobpl_const_554, out_escjunk);
    assume value_is(__ctobpl_const_555, out_result.esc$3);
    goto label_23;

  label_14:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 275} true;
    call out_result.esc$3 := esc(in_arg, in_i);
    assume value_is(__ctobpl_const_550, in_arg);
    assume value_is(__ctobpl_const_551, Mem_T.INT4[in_i]);
    assume value_is(__ctobpl_const_552, in_arg);
    assume value_is(__ctobpl_const_553, Mem_T.INT4[in_i]);
    goto label_22;
...
implementation putsub_loop_label_12_head(in_$fputc.arg.1$4$: int, in_$fputc.arg.2$3$: int, in_j: int, in_lin: int, in_result.__iob_func$2: int, in_result.fputc$1: int, in_s2: int) returns (out_$fputc.arg.1$4$: int, out_$fputc.arg.2$3$: int, out_j: int, out_result.__iob_func$2: int, out_result.fputc$1: int)
{
  ...
  label_12_false:
    ...
    assume value_is(__ctobpl_const_705, out_j);
    assume value_is(__ctobpl_const_706, in_s2);
    out_$fputc.arg.1$4$, out_$fputc.arg.2$3$, out_j, out_result.__iob_func$2, out_result.fputc$1 := in_$fputc.arg.1$4$, in_$fputc.arg.2$3$, in_j, in_result.__iob_func$2, in_result.fputc$1;
    return;
  ...
  label_18:
    ...
    assume value_is(__ctobpl_const_712, in_lin);
    assume value_is(__ctobpl_const_713, out_j);
    assume value_is(__ctobpl_const_714, Mem_T.CHAR[PLUS(in_lin, 1, out_j)]);
    goto label_19;
  ...
  label_17:
    ...
    assume value_is(__ctobpl_const_709, out_$fputc.arg.2$3$);
    assume value_is(__ctobpl_const_710, out_result.__iob_func$2);
    goto label_18;
...
implementation putsub_loop_label_6_head(in_$fputc.arg.1$4$: int, in_$fputc.arg.1$8$: int, in_$fputc.arg.2$3$: int, in_$fputc.arg.2$7$: int, in_i: int, in_j: int, in_lin: int, in_result.__iob_func$2: int, in_result.__iob_func$6: int, in_result.fputc$1: int, in_result.fputc$5: int, in_s1: int, in_s2: int, in_sub: int) returns (out_$fputc.arg.1$4$: int, out_$fputc.arg.1$8$: int, out_$fputc.arg.2$3$: int, out_$fputc.arg.2$7$: int, out_i: int, out_j: int, out_result.__iob_func$2: int, out_result.__iob_func$6: int, out_result.fputc$1: int, out_result.fputc$5: int)
{
  ...
  label_6_false:
    ...
    assume value_is(__ctobpl_const_687, in_sub);
    assume value_is(__ctobpl_const_688, out_i);
    assume value_is(__ctobpl_const_689, Mem_T.CHAR[PLUS(in_sub, 1, out_i)]);
    out_$fputc.arg.1$4$, out_$fputc.arg.1$8$, out_$fputc.arg.2$3$, out_$fputc.arg.2$7$, out_i, out_j, out_result.__iob_func$2, out_result.__iob_func$6, out_result.fputc$1, out_result.fputc$5 := in_$fputc.arg.1$4$, in_$fputc.arg.1$8$, in_$fputc.arg.2$3$, in_$fputc.arg.2$7$, in_i, in_j, in_result.__iob_func$2, in_result.__iob_func$6, in_result.fputc$1, in_result.fputc$5;
    return;
  ...
  label_13:
    ...
    assume value_is(__ctobpl_const_707, out_i);
    assume value_is(__ctobpl_const_708, out_i);
    goto label_13_dummy;
  ...
  label_11:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 470} true;
    out_j := in_s1;
    assume value_is(__ctobpl_const_703, out_j);
    assume value_is(__ctobpl_const_704, in_s1);
    goto label_12;
  ...
  label_23:
    ...
    assume value_is(__ctobpl_const_693, out_$fputc.arg.2$7$);
    assume value_is(__ctobpl_const_694, out_result.__iob_func$6);
    goto label_24;
...
implementation stclose_loop_label_7_head(in_$addstr.arg.1$2$: int, in_jp: int, in_jt: int, in_junk: int, in_lastj: int, in_pat: int, in_result.addstr$1: int) returns (out_$addstr.arg.1$2$: int, out_jp: int, out_junk: int, out_result.addstr$1: int)
{
  ...
  label_7_false:
    ...
    assume value_is(__ctobpl_const_723, in_lastj);
  ...
  label_15:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 165} true;
    assume value_is(__ctobpl_const_746, out_jp);
  ...
  label_14:
    ...
    assume value_is(__ctobpl_const_744, out_junk);
    assume value_is(__ctobpl_const_745, out_result.addstr$1);
    goto label_15;
  ...
  label_11:
    ...
    assume value_is(__ctobpl_const_743, Mem_T.INT4[in_jt]);
    goto label_14;
  ...
  label_10:
    ...
    assume value_is(__ctobpl_const_734, out_$addstr.arg.1$2$);
    assume value_is(__ctobpl_const_735, in_pat);
    assume value_is(__ctobpl_const_736, out_jp);
    assume value_is(__ctobpl_const_737, Mem_T.CHAR[PLUS(in_pat, 1, out_jp)]);
    goto label_11;

  label_9:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 167} true;
    Mem_T.INT4 := Mem_T.INT4[in_jt := PLUS(out_jp, 1, 1)];
    assume value_is(__ctobpl_const_732, Mem_T.INT4[in_jt]);
...
implementation subline_loop_label_8_head(in_$fputc.arg.1$5$: int, in_$fputc.arg.2$4$: int, in_i: int, in_lastm: int, in_lin: int, in_m: int, in_pat: int, in_result.__iob_func$3: int, in_result.amatch$1: int, in_result.fputc$2: int, in_sub: int) returns (out_$fputc.arg.1$5$: int, out_$fputc.arg.2$4$: int, out_i: int, out_lastm: int, out_m: int, out_result.__iob_func$3: int, out_result.amatch$1: int, out_result.fputc$2: int)
{
  ...
  label_8_false:
    ...
    assume value_is(__ctobpl_const_751, Mem_T.CHAR[PLUS(in_lin, 1, out_i)]);
    out_$fputc.arg.1$5$, out_$fputc.arg.2$4$, out_i, out_lastm, out_m, out_result.__iob_func$3, out_result.amatch$1, out_result.fputc$2 := in_$fputc.arg.1$5$, in_$fputc.arg.2$4$, in_i, in_lastm, in_m, in_result.__iob_func$3, in_result.amatch$1, in_result.fputc$2;
    return;
  ...
  label_15_false:
    ...
    assume value_is(__ctobpl_const_761, out_lastm);
  ...
  label_19:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 497} true;
    out_lastm := out_m;
    assume value_is(__ctobpl_const_771, out_lastm);
  ...
  label_16:
    ...
    assume value_is(__ctobpl_const_766, in_sub);
  ...
  label_12:
    ...
    assume value_is(__ctobpl_const_758, out_m);
    assume value_is(__ctobpl_const_759, out_result.amatch$1);
    goto label_13;

  label_9:
    assert {:sourcefile ".\v10\replace.c"} {:sourceline 494} true;
    call out_result.amatch$1 := amatch(in_lin, out_i, in_pat, 0);
    assume value_is(__ctobpl_const_752, in_lin);
    assume value_is(__ctobpl_const_753, out_i);
    assume value_is(__ctobpl_const_754, in_pat);
    assume value_is(__ctobpl_const_755, in_lin);
    assume value_is(__ctobpl_const_756, out_i);
    assume value_is(__ctobpl_const_757, in_pat);
    goto label_12;
  ...
  label_25:
    ...
    assume value_is(__ctobpl_const_781, in_lin);
    assume value_is(__ctobpl_const_782, out_i);
    assume value_is(__ctobpl_const_783, Mem_T.CHAR[PLUS(in_lin, 1, out_i)]);
    goto label_26;
  ...
  label_24:
    ...
    assume value_is(__ctobpl_const_778, out_$fputc.arg.2$4$);
    assume value_is(__ctobpl_const_779, out_result.__iob_func$3);
    goto label_25;
