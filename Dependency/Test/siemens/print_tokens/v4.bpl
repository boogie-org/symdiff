...
implementation get_token_loop_label_21_head(in_ch: int, in_cu_state: int, in_next_st: int, in_result.check_delimiter$13: int, in_result.get_char$12: int, in_result.get_char$24: int, in_result.next_state$4: int, in_result.skip$23: int, in_result.unget_char$16: int, in_token_found: int, in_token_ind: int, in_token_str: int, in_tstream_ptr: int) returns (out_ch: int, out_cu_state: int, out_next_st: int, out_result.check_delimiter$13: int, out_result.get_char$12: int, out_result.get_char$24: int, out_result.next_state$4: int, out_result.skip$23: int, out_result.unget_char$16: int, out_token_ind: int)
{
  ...
  label_74:
    ...
    assume value_is(__ctobpl_const_182, out_ch);
    assume value_is(__ctobpl_const_183, out_result.get_char$24);
    goto label_74_dummy;
  ...
  label_71:
    ...
    assume value_is(__ctobpl_const_178, in_tstream_ptr);
    assume value_is(__ctobpl_const_179, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
  ...
  label_70:
    ...
    assume value_is(__ctobpl_const_176, out_cu_state);
...
implementation main_loop_label_21_head(in_result.get_token$9: int, in_result.is_eof_token$8: int, in_result.print_token$10: int, in_stream_ptr: int, in_token_ptr: int) returns (out_result.get_token$9: int, out_result.is_eof_token$8: int, out_result.print_token$10: int, out_token_ptr: int)
{
  ...
  label_21_head:
    ...
    assume value_is(__ctobpl_const_242, in_stream_ptr);
    assume value_is(__ctobpl_const_243, in_stream_ptr);
    goto label_24;
  ...
  label_29:
    ...
    assume value_is(__ctobpl_const_250, out_token_ptr);
    goto label_29_dummy;

  label_28_false:
    assume out_result.is_eof_token$8 == 0;
    assume value_is(__ctobpl_const_248, out_result.is_eof_token$8);
    goto label_29;
  ...
  label_25:
    ...
    assume value_is(__ctobpl_const_247, out_token_ptr);
    goto label_28;

  label_24:
    assert {:sourcefile ".\v4\print_tokens.c"} {:sourceline 41} true;
    out_token_ptr := out_result.get_token$9;
    assume value_is(__ctobpl_const_244, out_token_ptr);
    assume value_is(__ctobpl_const_245, out_result.get_token$9);
    goto label_25;
...
implementation numeric_case_loop_label_9_head(in_ch: int, in_result.check_delimiter$3: int, in_result.get_char$4: int, in_token_ind: int, in_token_str: int, in_tstream_ptr: int) returns (out_ch: int, out_result.check_delimiter$3: int, out_result.get_char$4: int, out_token_ind: int)
{
  ...
  label_9_head:
    ...
    assume value_is(__ctobpl_const_307, out_ch);
    assume value_is(__ctobpl_const_308, out_ch);
    goto label_12;
  ...
  label_31:
    ...
    assert in_token_str != 0;
    Mem_T.CHAR := Mem_T.CHAR[PLUS(in_token_str, 1, out_token_ind) := out_ch];
    assume value_is(__ctobpl_const_317, in_token_str);
    assume value_is(__ctobpl_const_318, out_token_ind);
    out_token_ind := PLUS(out_token_ind, 1, 1);
    assume value_is(__ctobpl_const_319, Mem_T.CHAR[PLUS(in_token_str, 1, out_token_ind)]);
    assume value_is(__ctobpl_const_320, out_ch);
    goto label_31_dummy;

  label_30:
    assert {:sourcefile ".\v4\print_tokens.c"} {:sourceline 282} true;
    out_ch := out_result.get_char$4;
    assume value_is(__ctobpl_const_315, out_ch);
    assume value_is(__ctobpl_const_316, out_result.get_char$4);
    goto label_31;
  ...
  label_26:
    ...
    assume value_is(__ctobpl_const_311, in_tstream_ptr);
    assume value_is(__ctobpl_const_312, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
  ...
  label_13_false:
    ...
    assume value_is(__ctobpl_const_310, out_token_ind);
    goto label_26;
  ...
  label_12_false:
    ...
    assume value_is(__ctobpl_const_309, out_result.check_delimiter$3);
    goto label_13;
...
implementation skip_loop_label_4_head(in_c: int, in_result.get_char$2: int, in_result.is_end_of_character_stream$3: int, in_stream_ptr: int) returns (out_c: int, out_result.get_char$2: int, out_result.is_end_of_character_stream$3: int)
{
  ...
  label_4_head:
    ...
    assume value_is(__ctobpl_const_429, in_stream_ptr);
    assume value_is(__ctobpl_const_430, in_stream_ptr);
    goto label_7;

  label_13_false:
    assume out_result.is_end_of_character_stream$3 == 0;
    assume value_is(__ctobpl_const_436, out_result.is_end_of_character_stream$3);
    goto label_13_false_dummy;
  ...
  label_10:
    ...
    assume value_is(__ctobpl_const_434, in_stream_ptr);
    assume value_is(__ctobpl_const_435, in_stream_ptr);
    goto label_13;
  ...
  label_7:
    ...
    assume value_is(__ctobpl_const_431, out_c);
    assume value_is(__ctobpl_const_432, out_result.get_char$2);
    goto label_8;
