...
implementation get_token_loop_label_21_head(in_ch: int, in_cu_state: int, in_next_st: int, in_result.check_delimiter$13: int, in_result.get_char$12: int, in_result.get_char$24: int, in_result.next_state$4: int, in_result.skip$23: int, in_result.unget_char$16: int, in_token_found: int, in_token_ind: int, in_token_str: int, in_tstream_ptr: int) returns (out_ch: int, out_cu_state: int, out_next_st: int, out_result.check_delimiter$13: int, out_result.get_char$12: int, out_result.get_char$24: int, out_result.next_state$4: int, out_result.skip$23: int, out_result.unget_char$16: int, out_token_ind: int)
{
  ...
  label_65:
    ...
    assume value_is(__ctobpl_const_151, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    assume value_is(__ctobpl_const_152, in_tstream_ptr);
    assume value_is(__ctobpl_const_153, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    goto label_68;
  ...
  label_94:
    ...
    assume value_is(__ctobpl_const_171, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    goto label_106;
  ...
  label_56:
    ...
    assume value_is(__ctobpl_const_158, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    assume value_is(__ctobpl_const_159, in_tstream_ptr);
    assume value_is(__ctobpl_const_160, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    goto label_89;
...
implementation numeric_case_loop_label_9_head(in_ch: int, in_result.check_delimiter$3: int, in_result.get_char$4: int, in_token_ind: int, in_token_str: int, in_tstream_ptr: int) returns (out_ch: int, out_result.check_delimiter$3: int, out_result.get_char$4: int, out_token_ind: int)
{
  ...
  label_26:
    ...
    assume value_is(__ctobpl_const_314, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    assume value_is(__ctobpl_const_315, in_tstream_ptr);
    assume value_is(__ctobpl_const_316, Mem_T.ch_stream_token_stream_type[ch_stream_token_stream_type(in_tstream_ptr)]);
    goto label_30;
