...
implementation is_num_constant_loop_label_11_head(in_i: int, in_$isdigit.arg.1$5$_123_$static$: int, in_result.isdigit$4: int, in_str: int) returns (out_i: int, out_$isdigit.arg.1$5$_123_$static$: int, out_result.isdigit$4: int)
{
  ...
  label_13:
    assert {:sourcefile ".\v6\print_tokens2.c"} {:sourceline 358} true;
    assert PLUS(PLUS(in_str, 1, out_i), 1, 1) != 0;
    out_$isdigit.arg.1$5$_123_$static$ := Mem_T.CHAR[PLUS(PLUS(in_str, 1, out_i), 1, 1)];
    ...
    assume value_is(__ctobpl_const_158, Mem_T.CHAR[PLUS(PLUS(in_str, 1, out_i), 1, 1)]);
    goto label_14;
